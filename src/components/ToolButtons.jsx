...
export default function ToolButtons() {
  return (
    <div id="toolButtonsWrapper" className="tool_wrapper">
      <input id="tool0" type="radio" value="0" name="tool" defaultChecked className="hidden" />
      ...
      <input id="tool1" type="radio" value="1" name="tool" className="hidden" />
      <label htmlFor="tool1" title="erase tiles" data-value="1">🗑️</label>
      <input id="tool2" type="radio" value="2" name="tool" className="hidden" />
      <label htmlFor="tool2" title="pan" data-value="2">✋</label>
      <input id="tool3" type="radio" value="3" name="tool" className="hidden" />
      <label htmlFor="tool3" title="pick tile" data-value="3">🎨</label>
      <input id="tool4" type="radio" value="4" name="tool" className="hidden" />
      <label htmlFor="tool4" title="random from selected" data-value="4">🎲</label>
      <input id="tool5" type="radio" value="5" name="tool" className="hidden" />
